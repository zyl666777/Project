        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-8 text-center">
              <h1 class="font-weight-bold wow fadeInLeft">登入</h1>
              <p class="intro-description wow fadeInRight">WELCOME!</p>
            </div>
          </div>
        </div>
      </section>
      <!-- About page about section-->
      <section class="section section-md" style="text-align: center;">
   <form action="LoginComplete.jsp" method="post">      
        <div style="display: inline-block; text-align: left;">
          
           <!--   <label>輸入姓名</label><input type="text" name="name"><p>
           --> <p><select name="role">
                <option>請選擇登入身分</option>
                <option value="doctor">醫生</option>
                <option value="apply">申報人員</option>
                <option value="admin">管理員</option>
            </select></p>
            <label>帳號</label><input type="text" name="account"><p>
            <label>密碼</label><input type="password" name="password"><p> <!-- 使用type="password"來隱藏密碼輸入 -->
            <input type="submit">
        </div>
        </form>
    </section>
        ...
        <div class="container">
          <div class="row row-30">
            <div class="col-lg-3 wow fadeInLeft">
              <!--Brand--><a class="brand" href="index.html"><img class="brand-logo-dark" src="images/logo-default-200x34.png" alt="" width="100" height="17"/><img class="brand-logo-light" src="images/logo-inverse-200x34.png" alt="" width="100" height="17"/></a>
              <p class="footer-classic-description offset-top-0 offset-right-25">consultBiz provides a full range of business consulting & advisory services to small, medium, and international companies worldwide. We use innovations and experience to drive your success.</p>
            </div>
